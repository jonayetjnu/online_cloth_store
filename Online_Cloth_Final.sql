...
INSERT INTO `category` (`cat_id`,`cat_name`,`cat_desc`) VALUES 
 (1,'T-Shirt','Export Quality'),
 (2,'Jeans','Export Quality'),
 (3,'Panjabi','Good');
...
INSERT INTO `product` (`pro_id`,`sub_cat_id`,`pro_name`,`pro_qty`,`pro_price`,`pro_url`,`pro_desc`) VALUES 
 (1,2,'Batmat-Green',10,400,'1.jpg','Export Quality'),
 (2,2,'Batmat-Ash',10,400,'2.jpg','Export Quality'),
 (3,2,'Batman-Yellow',10,400,'3.jpg','Export Quality'),
 (4,2,'Diamond-Ash',15,450,'4.jpg','Export Quality'),
 (5,2,'Full-Ash',15,350,'5..jpg','Export Quality'),
 (6,2,'Sweet_One',15,350,'11.jpg','Export Quality'),
 (7,2,'Sweet_Blue',15,350,'12.jpg','Export Quality'),
 (8,2,'Full_Black',15,350,'8.jpg','Export Quality');
...
INSERT INTO `sub_category` (`sub_cat_id`,`cat_id`,`sub_cat_name`,`sub_cat_desc`) VALUES 
 (1,1,'Ladies','Good Quality'),
 (2,1,'Gents','Good Quality'),
 (3,2,'Ladies','Good Quality'),
 (4,2,'Gents','Good Quality'),
 (5,1,'Baby','Good quality'),
 (6,3,'Baby','Good');
